...
public class RecipeIngredientRepositoryImpl implements RecipeIngredientRepository {
    ...
    private static final String SELECT_BY_RECIPE_ID = "SELECT * FROM RecipeIngredient WHERE recipe_id = ?";
    private static final String SELECT_BY_INGREDIENT_ID = "SELECT * FROM RecipeIngredient WHERE ingredient_id = ?";
    ...
    private static final String DELETE_RECIPE_INGREDIENT =
            "DELETE FROM RecipeIngredient WHERE recipe_id = ? AND ingredient_id = ?";
